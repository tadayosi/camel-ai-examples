// camel-k: language=java dependency=ai.djl:model-zoo:0.28.0 dependency=ai.djl.pytorch:pytorch-engine:0.28.0 dependency=ai.djl.pytorch:pytorch-jni:2.3.0-0.28.0 dependency=ai.djl.pytorch:pytorch-native-cpu:2.3.0
